...
export default function ArticleMain({title,section, _id, summary, date}: Props){
    ...
    return(
        <Link href={`/${section}/${titleURL}`} className="text-left text-white flex flex-col justify-end items-center gap-4 p-2 bg-gradient-to-t from-black to-transparent h-full w-full hover:text-title">
